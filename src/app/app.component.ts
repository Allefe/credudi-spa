...
export class AppComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    KEY_DIALOG_HTTP_SERVICE = environment.KEY_DIALOG_HTTP_SERVICE;

    isAuthRoute = false;
    isLoading = false;

    mostrarDialogMensagem: boolean = false;
    ...
    constructor(public renderer2: Renderer2, public zone: NgZone, private loader: PxtLoadingService, private authService: AuthService) {}

    ngOnInit() {
        if (!this.isAuthRoute) this.zone.runOutsideAngular(() => {this.bindRipple(); });
        ...
        this.authService.isAuthRoute$.subscribe(is => {
            this.isAuthRoute = is;
        } );
    }
